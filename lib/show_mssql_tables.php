<?php
	...
	$dbCon = @mssql_connect($dbserver, $username, $password) or die("connect error! check your username and password.");
	...
	while ($row = mssql_fetch_array($table_array))
	{
		$table_name = $row["Name"];
		...
		while ($property = mssql_fetch_array($column_array))
		{
			$column_info .= "<tr>";
