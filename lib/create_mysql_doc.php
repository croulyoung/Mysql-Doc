<?php
	...
	$dbCon = @mysql_connect($dbserver, $username, $password) or die("Connect error! Check your username and password please.");
	...
	$dir = realpath(dirname(__FILE__).'/../') . '\\mysql_doc\\' . $folderName;
	create_folder($dir);
	...
	while ($r = mysql_fetch_array($table_array))
	{
		$rows[] = $r;
